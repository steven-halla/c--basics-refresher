...
namespace practise
{
    ...
    class Program
    {
        ...
        {   
            ...
            string[] nars = {"narwhale", "carwhale", "horsewhale", "whalewhale"};
            Console.WriteLine(nars[0]);

            //change the value of an specific element -you need to refer to an index number
            nars[0] ="diamondwhale";
            Console.WriteLine(nars[0]);
            Console.WriteLine(nars.Length);
            ...
            //foreach loop
            string[] dars = {"1", "2", "3", "stop"};
            foreach (string i in dars)
            {
                Console.WriteLine(i);
            }

            //System.Linq Namespace
            int[] coolNums = {5,4,2,9};
            Console.WriteLine(coolNums.Max());
            Console.WriteLine(coolNums.Min());
            Console.WriteLine(coolNums.Sum());
